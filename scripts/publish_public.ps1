...
Write-Host "[*] Iniciando sincronización profesional de ModelForge-API..." -ForegroundColor Cyan
...
Remove-Item -Path "data/*.pkl", "data/*.joblib" -Force -ErrorAction SilentlyContinue

# 3. Sincronización con Laboratorio Privado
Write-Host "[*] Asegurando estado en GitLab (origin-gitlab)..."
